...
! function (t) {
    ...
    return h.prototype = {
        ...
        open: function (e) {
            function i() {
                o.state = r.OPENED, o.$element.trigger(r.OPENED), !o.options.onOpened || "function" != typeof o.options.onOpened && "object" != typeof o.options.onOpened || o.options.onOpened(o)
            }
            ...
            if (t.each(t("." + a), function (e, i) {
                ...
                }(this.options.bodyOverflow || d) && (t("html").addClass(a + "-isOverflow"), d && t("body").css("overflow", "hidden")), this.options.onOpening && "function" == typeof this.options.onOpening && this.options.onOpening(this),
                    function () {
                        ...
                        "object" == typeof e && (void 0 === e.transition && void 0 === e.transitionIn || (r = e.transition || e.transitionIn)), "" !== r && void 0 !== l ? (o.$element.addClass("transitionIn " + r).show(), o.$wrap.one(l, function () {
        ...
        for (var r = this, l = 0; l < r.length; l++) {
            var d = t(r[l]),
                c = d.data(a),
                u = t.extend({}, t.fn[a].defaults, d.data(), "object" == typeof e && e);
